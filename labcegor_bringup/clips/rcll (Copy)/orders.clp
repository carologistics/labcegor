...
=>
  ;(if(and (eq ?oidTask ?oidWaiting) (eq ?machineNameMachine ?machineNameWaiting))
  ;  then
    (retract ?waiting-f)
    ;(modify ?machine-f (waitingFor FALSE))

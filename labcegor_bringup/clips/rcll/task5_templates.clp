...
(deffacts order_facts
  (adjustable_order (id 0))
  (adjustable_order (id 1))
  (adjustable_order (id 2))
  (adjustable_order (id 3))
  (adjustable_order (id 4))
  (adjustable_order (id 5))
  (adjustable_order (id 6))
  (adjustable_order (id 7))
  (adjustable_order (id 8))
  (adjustable_order (id 9))
  (adjustable_order (id 10))
  (adjustable_order (id 11))
  (adjustable_order (id 12))
)
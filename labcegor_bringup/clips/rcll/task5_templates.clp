...
(deffacts robottasks
  ...
  (tasks_overview (robot_id 2) (robot_type PAYMENT) (task_id 1) (can_move TRUE) (can_retrieve FALSE) (can_deliver FALSE) (state IDLE) (move_target M-CS2) (machine_target "Input" ))
